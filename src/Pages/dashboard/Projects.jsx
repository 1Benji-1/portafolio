      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="sm:col-span-2">
          <InputField
            ...
            value={form.Title}
            onChange={set("Title")}
            placeholder="e.g. My Website Website"
            required
          />
        </div>
...
export default function Projects() {
  ...
  const fetchProjects = async () => {
    ...
    if (error) {
      ...
      alert("No se pudieron cargar los proyectos: " + error.message);
    }
  ...
  // Sube la imagen y devuelve la URL pública, o null si algo falló.
  ...
  const handleCreate = async (form, file) => {
    ...
    if (file) {
      ...
      if (imgUrl === null) {
        // La subida de imagen falló, no seguimos con el insert.
        setUploading(false);
        return;
      }
    }
