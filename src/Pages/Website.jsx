              ...
              >
                ...
                <div className="relative z-10">
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-widest text-slate-500 bg-slate-50 px-3 py-1.5 rounded-full border border-slate-100 group-hover:bg-white/10 group-hover:text-slate-300 group-hover:border-white/10 transition-colors duration-500">
                      {t(service.badgeKey)}
                    </span>
                  </div>

                  <h4 className="font-extrabold text-slate-900 text-xl mb-3 leading-snug group-hover:text-white transition-colors duration-500">
                    {t(service.titleKey)}
                  </h4>
