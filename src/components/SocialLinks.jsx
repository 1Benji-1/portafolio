...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/bulacia-yoel/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@bulacia_yoel",
    icon: Instagram,
    url: "https://www.instagram.com/bulacia_yoel/?hl=id",
    color: "#E4405F",
  ...
  },
  {
    ...
    url: "https://tiktok.com/@bulacia_yoel",
    color: "black",
...
const SocialLinks = () => {
  ...
  // Se actualiza la desestructuración, reemplazando "youtube" por "whatsapp"
